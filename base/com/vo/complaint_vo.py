...
class ComplaintVO(db.Model):
    ...
    complaint_status = db.Column('complaint_status', db.String(10), nullable=False)
    ...
    complaint_from_login_id = db.Column('complaint_from_login_id', db.Integer,
                                        db.ForeignKey(LoginVO.login_id, ondelete='CASCADE'))
    complaint_to_login_id = db.Column('complaint_to_login_id', db.Integer,
                                      db.ForeignKey(LoginVO.login_id, ondelete='CASCADE'), nullable=True)
    ...
    def as_dict(self):
        return {
            ...
            'complaint_reply': self.complaint_reply,
